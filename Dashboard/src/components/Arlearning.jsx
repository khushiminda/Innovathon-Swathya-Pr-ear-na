...
import mgcms from "../assets/rt_main_bronchus_fistula.glb";
import hamzatyellow from "../assets/mri_scan.glb";
import dgc from "../assets/auxiliary_manual_breathing_unit_ambu_-_nina.glb";
import dosi from "../assets/sci-fi_mri.glb";
import geig from "../assets/rt_main_bronchus_fistula.glb";
import image1 from '../assets/Screenshot 2024-08-13 125110.png';
import image2 from '../assets/therapyroom.png';
    ...
    return (
        <div className="bg-gray-50">
            ...
            <div className="text-center py-8">
                <h1 className="mt-5 text-5xl font-bold text-pink-600">Virtual Equipment Learning</h1>
            </div>
            ...
            <div className="flex flex-wrap justify-center px-8 ml-[0px] sm:ml-[10%]">
                ...
                {/* Section 3 */}
                <section className="max-w-md bg-white shadow-md m-5 p-5 rounded-lg transition-transform transform hover:scale-105">
                    <h4 className="text-2xl font-bold tracking-wide mt-5 mb-4 text-pink-600">Auxiliary manual breathing unit</h4>
                    <p className="description bg-gray-100 text-gray-700 rounded-lg p-4 mb-4">
